// ****************************************************************
// * Initially forked from Elgato's sdtools.common.js file
...
function websocketOnMessage(evt) {
    ...
    if (jsonObj.event === 'didReceiveSettings' || jsonObj.event === 'didReceiveGlobalSettings') {
...
function setSettingsWithTimeout(val = 1000) {
...
function setGlobalSettingsWithTimeout(val = 1000) {
    clearTimeout(globalSettingsTimeout);
    globalSettingsTimeout = setTimeout(function () {
        clearTimeout(globalSettingsTimeout);
        setGlobalSettings();
    }, val);
}
...
function setGlobalSettings() {
    var payload = getGlobalSettingsPayload();
...
function getGlobalSettingsPayload() {
    var payload = {};
    var elements = document.getElementsByClassName("sdPropertyGlobal");
    ...
    Array.prototype.forEach.call(elements, function (elem) {
        ...
        console.log("Save global: " + key + "<=" + payload[key]);
    });
    return payload;
}
